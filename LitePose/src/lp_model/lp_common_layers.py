...
class ConvBlockBase(nn.Sequential):
    # the basic building block of the network
...
class ConvMobileBlock(nn.Module):
    # a block with mobile connectivity and residual connection
...
class ConvStage(nn.Module):
    # a sequence of ConvMobileBlocks for each stage of the backbone
